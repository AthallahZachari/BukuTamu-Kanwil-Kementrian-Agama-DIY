...
<form action="" method="POST" id="myForm" class="flex flex-col space-y-4">
    <!-- [ BIODATA ] -->
    ...
    <section class="flex flex-col sm:flex-row gap-4">
        <div class="w-full sm:w-[60%] pr-5">
            <label for="telepon" class="block text-slate-800 font-semibold px-1 pb-2">Nomor HP/Telephone</label>
            <input type="text" name="telepon" id="telepon" placeholder="No. Aktif..." onkeypress="validateNumberInput(event)" class="w-full rounded-md px-4 py-1 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-emerald-400">
        </div>

        <div class="w-full sm:w-[30%]">
            <label for="layanan" class="block text-slate-800 font-semibold px-1 pb-2">Layanan</label>
            <a id="dropdownButton" onclick="togglePopup()" class="w-full px-3 py-2 mb-4 rounded-md border border-gray-300 hover:cursor-pointer focus:outline-none focus:ring-1 focus:ring-emerald-400">
